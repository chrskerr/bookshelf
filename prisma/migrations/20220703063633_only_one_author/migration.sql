...
INSERT INTO "new_Book" ("bookNumber", "createdAt", "id", "isOwned", "isbn", "seriesId", "title", "updatedAt") SELECT "bookNumber", "createdAt", "id", "isOwned", "isbn", "seriesId", "title", "updatedAt" FROM "Book";
DROP TABLE "Book";
